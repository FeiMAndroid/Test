...
//            message.putString("extras",extras);
...
//        NotificationManager notificationManager = (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);
        ...
        if (JPushInterface.ACTION_MESSAGE_RECEIVED.equals(intent.getAction())) {
            ...
            Log.d(TAG, "Unhandled intent - " + bundle);
...
//                mIntent.putExtra("extras",s );
    ...
    public void stopPush(){
        ...
        Toast.makeText(getReactApplicationContext(),"取消推送",Toast.LENGTH_SHORT).show();
    }

    @ReactMethod
    public void resumePush(){
        JPushInterface.resumePush(getReactApplicationContext());
        Toast.makeText(getReactApplicationContext(),"恢复推送",Toast.LENGTH_SHORT).show();
    }
